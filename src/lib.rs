...
pub struct ItemElement {
    ...
    dice: Option<serde_json::Value>,
    restriction: Option<String>,
    stat_id: Option<serde_json::Value>,
    requires_attunement: bool,
    duration: Option<serde_json::Value>,
    friendly_type_name: String,
    friendly_subtype_name: String,
    is_granted: bool,
    bonus_types: Vec<Option<serde_json::Value>>,
    value: Option<i64>,
    available_to_multiclass: Option<bool>,
    modifier_type_id: i64,
    modifier_sub_type_id: i64,
    component_id: i64,
    component_type_id: i64,
    die: Option<WealthDice>,
    count: Option<i64>,
    duration_unit: Option<serde_json::Value>,
    use_primary_stat: Option<bool>,
    at_higher_levels: Option<AtHigherLevels>,
    tag_constraints: Option<Vec<Option<serde_json::Value>>>,
}
...
pub struct Modifiers {
    race: Vec<ItemElement>,
    class: Vec<ItemElement>,
    background: Vec<ItemElement>,
    item: Vec<ItemElement>,
    feat: Vec<Option<serde_json::Value>>,
    condition: Vec<Option<serde_json::Value>>,
}
