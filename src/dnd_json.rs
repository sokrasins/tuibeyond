...
pub struct Inventory {
    ...
    pub entity_type_id: serde_json::Value,
    pub definition: InventoryDefinition,
    pub definition_id: i64,
    pub definition_type_id: i64,
    pub display_as_attack: Option<serde_json::Value>,
    pub quantity: i64,
    pub is_attuned: bool,
    pub equipped: bool,
    ...
    pub limited_use: Option<InventoryLimitedUse>,
...
pub struct InventoryDefinition {
    ...
    pub source_page_number: Option<serde_json::Value>,
    pub stackable: bool,
    pub bundle_size: i64,
    pub avatar_url: Option<String>,
    pub large_avatar_url: Option<String>,
    pub filter_type: FilterType,
    pub cost: Option<f64>,
    pub is_pack: bool,
    pub tags: Vec<String>,
    pub granted_modifiers: Vec<ItemElement>,
    pub sub_type: Option<String>,
    pub is_consumable: bool,
    pub weapon_behaviors: Vec<Option<serde_json::Value>>,
    pub base_item_id: Option<i64>,
    pub base_armor_name: Option<String>,
    pub strength_requirement: Option<i64>,
    pub armor_class: Option<i64>,
    pub stealth_check: Option<i64>,
    pub damage: Option<WealthDice>,
    pub damage_type: Option<String>,
    pub fixed_damage: Option<serde_json::Value>,
    ...
    pub level_infusion_granted: Option<i64>,
